// Начальные данные для футбольного клуба ФК Аврора
...
export const initialNews = [
  {
    ...
    content: "ФК Аврора провела одну из лучших игр в этом сезоне. С самого начала матча мы захватили инициативу. На 12-й минуте Александр Морозов открыл счет красивым ударом в девятку после паса Дмитрия Смирнова. Во втором тайме соперник сравнял счет с пенальти, но дубль Максима Соколова принес нам заслуженную победу. Спасибо болельщикам за поддержку!",
    date: "2026-06-28",
  ...
  },
  {
    ...
    content: "В следующее воскресенье, 12 июля, ФК Аврора встретится с ФК Штурм. Это ключевой матч сезона: соперник опережает нас всего на 1 очко в турнирной таблице. Нам нужна только победа! Ждем всех игроков на предыгровой тренировке в среду.",
    date: "2026-07-05",
...
export const teamAboutInfo = {
  ...
  history: "Клуб был основан группой друзей и единомышленников в 2023 году. Начав с товарищеских матчей на районном стадионе, ФК Аврора быстро переросла в полноценную команду любительской лиги. Наше название символизирует яркое северное сияние и стремление всегда быть на высоте. Цвета команды — неоновый зеленый, глубокий синий и космический фиолетовый.",
